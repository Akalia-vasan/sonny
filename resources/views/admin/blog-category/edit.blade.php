...
@section('content')
    ...
    <div class="row" style="display:block;">
        <form action="{{ route('admin.b_category.update',$category->id) }}" method="post" >
                @csrf	
                @method('PUT')				
            <div class="col-12">
                <!-- Basic Information -->
                        ...
                        <div class="row form-row">
                            ...
                            <div class="col-12 col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="category_name" value="{{$category->category_name}}" class="form-control floating @error('category_name') is-invalid @enderror" required>
                                    @error('category_name')
