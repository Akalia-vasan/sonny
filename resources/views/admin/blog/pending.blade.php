                ...
                <div class="row mb-5">
                    <div class="col">
                        <ul class="nav nav-tabs nav-tabs-solid">
                            <li class="nav-item">
                                <a class="nav-link " href="{{ route('admin.blog.index')}}">Acitive Blog</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link active" href="{{ route('admin.blog.pending')}}">Pending Blog</a>
                            </li>
                        </ul>
                    </div>
                </div>
                        ...
                        <div class="col-md-6 col-xl-4 col-sm-12">
                            ...
                            <div class="blog grid-blog">
                                ...
                                <div class="blog-content">
                                        ...
                                        <li>
                                            <div class="post-author">
                                                <a href="{{route('admin.blog.comment',$allblog1->id)}}">
                                                    @if($allblog1->type =='doctor' && getdoctor($allblog1->author)->profile_image!=null)
                                                        <img src="{{getdoctor($allblog1->author)->profile_image}}" alt="Post Author">
                                                    @else
                                                        <img src="{{asset('assets/img/doctors/doctor-thumb-01.jpg')}}" alt="Post Author">
                                                    @endif
                                                    @if($allblog1->type =='admin')
                                                        <span> By Hospirent</span>
                                                    @else
                                                        <span>Dr. {{ getdoctor($allblog1->author)->name }} {{ getdoctor($allblog1->author)->l_name }}</span>
                                                    @endif
                                                </a>
                                            </div>
                                        </li>
                                    ...
                                    <h3 class="blog-title"><a href="#">{{ $allblog1->blog_title }}</a></h3>
                                ...
                                <div class="row pt-3">
                                    ...
                                    <div class="col text-right">
                                        <a href="javascript:void(0);" class="text-success demotest1" data-id="{{$allblog1->id}}"><i class="fa fa-eye"></i> Active</a>
