...
@section('content')
    ...
    <div class="page-header"> 
        <div class="row">
            <div class="col-sm-12"> 
                <h3 class="page-title">Speciality Add</h3>
                <ul class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{ route('admin.home')}}">Dashboard</a></li>
                    <li class="breadcrumb-item active">Speciality Add</li>
                </ul>
            </div>
        </div>
    </div>
                        ...
                        <div class="row form-row">
                            ...
                            <div class="col-12 col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="sp_name" value="{{old('sp_name')}}" class="form-control floating @error('sp_name') is-invalid @enderror" required>
                                    @error('sp_name')
                            ...
                            <div class="col-12 col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="file" name="sp_image" class="form-control floating @error('sp_image') is-invalid @enderror" required>
                                    @error('sp_image')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
