...
<div class="page-header">
    <div class="row">
        <div class="col-sm-12"> 
            <h3 class="page-title">Add Sub Admin</h3>
            <ul class="breadcrumb">
                    ...
                    <div class="row form-row">
                        ...
                        <div class="col-12 col-md-12">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="password" class="form-control" name="password" value="{{ old('password') }}"  id="password" placeholder="New Password" /> 
                        ...
                        {{-- <div class="col-12 col-md-12">
                            <div class="form-group">
                                ...
                                &nbsp &nbsp &nbsp &nbsp<input type="checkbox" name="status" class="js-switch" checked />
