...
@section('content')
    ...
    <div class="page-header">
        <div class="row">
            <div class="col-sm-12">
                <h3 class="page-title">Bed Add</h3>
                <ul class="breadcrumb">
    ...
    <div class="row" style="display:block;">
        <form action="{{ route('admin.bedbooking.store') }}" method="post">
                @csrf					
            <div class="col-12">
                <!-- Basic Information -->
                <div class="card">
                        ...
                        <div class="row form-row">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control select floating @error('hospital_id') is-invalid @enderror" name="hospital_id" required>
                                        ...
                                        @forelse ($hospitals as $item)
                                            <option {{ old('hospital_id') == $item->id ? "selected" : "" }} value="{{$item->id}}">{{$item->hospital_name}}</option>
                                        @empty
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control select floating @error('bed_type_id') is-invalid @enderror" name="bed_type_id" required>
                                        ...
                                        @forelse ($bedtype as $item)
                                            <option {{ old('bed_type_id') == $item->id ? "selected" : "" }} value="{{$item->id}}">{{$item->bed_type}}</option>
                                        @empty
                            ...
                            <div class="col-12 col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="number" min="1" name="aval_bed" value="{{old('aval_bed')}}" class="form-control floating @error('aval_bed') is-invalid @enderror" required>
                                    @error('aval_bed')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="col-12 col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="number" min="1" name="price" value="{{old('price')}}" class="form-control floating @error('price') is-invalid @enderror" required>
                                    @error('price')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
