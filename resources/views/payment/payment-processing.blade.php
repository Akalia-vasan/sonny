...
<form action="{{route('patient.complete.payment')}}" method="post" hidden>
    @csrf
      ...
      <input type="text" name="slot_id" id="slot_id" value="{{$response['slot_id']}}" class="form-control">
      <input type="text" name="pay_amount" value="{{$response['amount']/100}}" class="form-control">
      <input type="text" name="doctor_id" id="doctor_id" value="{{$response['doctor_id']}}" class="form-control">
