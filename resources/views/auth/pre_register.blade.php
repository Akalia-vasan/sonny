								...
								<div class="row align-items-center justify-content-center">
									...
									<div class="col-md-12 col-lg-6 login-right">
										...
										<form method="POST" action="{{ route('preregister') }}">
											...
											<div class="form-group form-focus">
                                                <input id="mobile" type="mobile" class="form-control floating @error('mobile') is-invalid @enderror" name="mobile" pattern="[6789][0-9]{9}" value="{{ old('mobile') }}" required autocomplete="mobile">
