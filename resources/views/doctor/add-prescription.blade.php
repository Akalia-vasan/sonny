            ...
            <div class="row">
                <div class="col-sm-6">
                    <div class="biller-info">
                        <h4 class="d-block">Dr. {{Auth::user()->name}} {{Auth::user()->l_name}}</h4>
                        <span class="d-block text-sm text-muted">{{Auth::user()->getspeciality->sp_name}}</span>
                        <span class="d-block text-sm text-muted">Japan</span>
                    </div>
                </div>
                <div class="col-sm-6 text-sm-right">
                    <div class="billing-info">
                        <h4 class="d-block">{{ \Carbon\Carbon::now()->format('d M Y')}}</h4>
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover table-center">
                            ...
                            <tbody class="add-prescription">
                                <tr>
                                    <td><input type="text" name="medicine[]" class="form-control floating @error("medicine") is-invalid @enderror " required></td>
