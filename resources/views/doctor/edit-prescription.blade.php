...
@section('content')
<form action="{{route('doctor.update.prescription')}}" method="POST">
    @csrf
    <div class="card">
                        ...
                        <table class="table table-hover table-center">
                            ...
                            <tbody class="add-prescription">
                                @foreach ($prescription->getdetail as $row)
                                    <tr>
                                        <td><input type="text"  value="{{$row->medicine}}" name="medicine[]" class="form-control"></td>
                                        <td><input type="text"  value="{{$row->quantity}}" name="qty[]" class="form-control"></td>
                                        <td><input type="text"  value="{{$row->days}}" name="day[]" class="form-control"></td>
                                        <td>
                                            <div class="form-check form-check-inline">
                                                <label class="form-check-label"> Morning <br>
                                                    <select name="morning[]" id="" class="form-check-input" >
                                            ...
                                            <div class="form-check form-check-inline">
                                                <label class="form-check-label"> Afternoon <br>
                                                    <select name="afternon[]" id="" class="form-check-input " >
                                            ...
                                            <div class="form-check form-check-inline">
                                                <label class="form-check-label"> Evening <br>
                                                    <select name="evening[]" id="" class="form-check-input " >
                                            ...
                                            <div class="form-check form-check-inline">
                                                <label class="form-check-label"> Night <br>
                                                    <select name="night[]" id="" class="form-check-input ">
