...
(function($) {
	...
	//add-prescription
	$(".add-prescription").on('click','.trash', function () {
		$(this).closest('.pres-count').remove();
		return false;
    });

	$(".add-more-prescription").on('click', function () {
		
		var educationcontent = '<tr class="pres-count"><td><input type="text" name="medicine[]" class="form-control floating @error("medicine") is-invalid @enderror " required></td>' +
			'<td><input type="text" name="qty[]" class="form-control floating @error("qty") is-invalid @enderror " required></td>' +
			'<td><input type="text" name="day[]" class="form-control floating @error("day") is-invalid @enderror " required></td>' +
			'<td>'+
				'<div class="form-check form-check-inline">'+
					'<label class="form-check-label"> Morning <br>'+
					'<select name="morning[]" id="" class="form-check-input floating @error("morning") is-invalid @enderror">'+
				...
				'<div class="form-check form-check-inline">'+
					...
					'<select name="afternon[]" id="" class="form-check-input floating @error("afternon") is-invalid @enderror">'+
						'<option value="0" >No</option>'+
				...
				'<div class="form-check form-check-inline">'+
					...
					'<select name="evening[]" id="" class="form-check-input floating @error("evening") is-invalid @enderror">'+
						'<option value="0" >No</option>'+
						'<option value="1" >Yes</option>'+
					'</select>'+
					'</label>'+
				...
				'<div class="form-check form-check-inline">'+
					...
					'<select name="night[]" id="" class="form-check-input floating @error("night") is-invalid @enderror">'+
						'<option value="0" >No</option>'+
						'<option value="1" selected>Yes</option>'+
					'</select>'+
					'</label>'+
			...
			'</td>'+
			'<td>'+
				'<a href="javascript:;" class="btn bg-danger-light trash"><i class="far fa-trash-alt"></i></a>'+
			'</td>'+
	'</tr>';
		
        $(".add-prescription").append(educationcontent);
        return false;
    });
