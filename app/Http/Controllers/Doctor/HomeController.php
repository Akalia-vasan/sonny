...
class HomeController extends Controller
{
    public function index()
    {
        ...
        // $data['today_patient'] = User::where('doctor_id',auth()->user()->id)->whereDate('created_at',Carbon::today())->count();
        
        //dd($data['today_appontments']);
    ...
    public function changeprofile()
    {
        ...
        // $data['city']=City::where('state_id',Auth::user()->state_id)->get();
        return view('doctor.change-profile',$data);
    }

    public function changeSocialLink()
    {
        $data['breadcrumb'] = 'Social Media';
        return view('doctor.social-media',$data);
    }
    ...
    public function updateprofile(Request $request)
    {
        ...
        return redirect()->route('doctor.change_profile')->with('success','Profile Updated!');
    }
    ...
    public function updateSocialLink(Request $request)
    {
        ...
        $doctor->update();  
        return redirect()->route('doctor.change_social_link')->with('success','Social Media Updated!');
    }
    ...
    public function viewScheduleTiming()
    {
        $data['breadcrumb'] = 'Schedule Timings';
        return view('doctor.schedule-timing',$data);
    }
    ...
    public function viewReview()
    {
        ...
        return view('doctor.review',$data);
    }
    ...
    public function patientdetail($id) 
    {
        ...
        $data['patient_id'] = $id;
        // dd($id);
        return view('doctor.patient-profile',$data);
    }
    ...
    public function showpatintPrescription($id)
    {
        ...
        $data['patient_id'] = $id;
        return view('doctor.show-prescription',$data);
    }
    ...
    public function storepatintPrescription(Request $request)
    {
      ...
      //dd($request->all());
        ...
        if($prescription->save()){
            ...
            return redirect()->route('doctor.patient')->with('success','Prescription Added!');
        }
    ...
    public function updatepatintPrescription(Request $request)
    {
      ...
      //dd($request->all());
            ...
            return redirect()->route('doctor.patient')->with('success','Prescription Updated!');
