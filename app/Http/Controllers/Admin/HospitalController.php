...
class HospitalController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $Hospital->save();
        return redirect()->route('admin.hospital.index')->with('success','Hospital Added!');
    }
    ...
    public function show($id)
    {
        ...
        return view('admin.hospital.show',$data);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        if($validator->fails())
        {
            ...
            $Hospital->save();
        return redirect()->route('admin.hospital.index')->with('success','Hospital Updated!');
    }
    ...
    public function destroy($id)
    {
        $hospital = Hospital::where('id',$id)->first();
        $hospital->delete();
        return redirect()->route('admin.hospital.index')->with('success','Hospital Deleted!');
    }
