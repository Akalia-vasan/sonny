...
class ProductController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('admin.product.index')->with('success','Product Update!');
    }
    ...
    public function destroy($id)
    {
        ...
        if($Product->delete())
        {
            ...
            return response()->json(['status' => '1','massage'=>'Product Deleted!']);
        }
        else
        {
            Session::flash('failed','Product Not Deleted!');
            return response()->json(['status' => '0','massage'=>'Product Not Deleted!']);
        }
    }
}
